  ...
  const generateAiDescription = useCallback(async () => {
    ...
    try {
      ...
      if (data?.html) {
        ...
        const engineLabel = data.engine === 'gemini' ? 'Gemini AI' : data.engine === 'local-fallback' ? 'Local (Gemini failed)' : 'Local Template'
        toast.success(`Description generated by ${engineLabel}! Review in the preview panel.`)
      } else {
